  ...
  return (
    <footer className="bg-dark-gray text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-lg font-semibold text-white">Müteahhitler Derneği</span>
            </div>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} Müteahhitler Derneği. Tüm hakları saklıdır.
        </div>
      </div>
    </footer>
  );
