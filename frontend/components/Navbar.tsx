        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          ...
          {hasToken ? (
            <>
              <Link
                href="/ilanlarim"
                className="hidden shrink-0 items-center justify-center rounded-md border border-burgundy/30 bg-white px-2 py-1.5 text-[11px] font-semibold text-burgundy transition-all hover:bg-burgundy/5 sm:inline-flex sm:px-3"
              >
                İlanlarım
              </Link>
              <Link
