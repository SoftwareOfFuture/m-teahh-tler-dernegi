...
export function HeroSlider({ items }: Props) {
  ...
  return (
    <section className="relative w-full overflow-hidden rounded-3xl bg-slate-900">
      <div className="relative h-[300px] sm:h-[360px] md:h-[460px] lg:h-[520px]">
        <Image
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="w-full p-4 sm:p-6 md:p-10">
            ...
            <div className="mt-5">
              <Link
                href="/kurumsal"
                className="inline-flex items-center justify-center rounded-full border-2 border-white/70 px-5 py-2 text-sm font-semibold text-white transition-colors hover:border-white hover:bg-white hover:text-slate-900 sm:px-6 sm:py-2.5"
              >
                DETAYLI İNCELE
              </Link>
            </div>
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 grid size-9 place-items-center rounded-full bg-white/10 text-white backdrop-blur transition-colors hover:bg-white/20 sm:left-4 sm:size-10"
          aria-label="Önceki"
        >
          <ChevronLeft />
        </button>
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 grid size-9 place-items-center rounded-full bg-white/10 text-white backdrop-blur transition-colors hover:bg-white/20 sm:right-4 sm:size-10"
          aria-label="Sonraki"
        >
          <ChevronRight />
        </button>
